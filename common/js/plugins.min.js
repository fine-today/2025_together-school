    ...
    (V.ui.position = {
      fit: {
        left: function (t, e) {
          ...
          i < e.collisionWidth
            ? 0 < o && a <= 0
              ? (t.left += o - (t.left + o + e.collisionWidth - i - s))
              : (t.left =
                  !(0 < a && o <= 0) && a < o ? s + i - e.collisionWidth : s)
            : 0 < o
            ? (t.left += o)
            : 0 < a
            ? (t.left -= a)
            : (t.left = k(t.left - n, t.left));
        },
        top: function (t, e) {
          var i = e.within,
          ...
          s < e.collisionHeight
            ? 0 < o && a <= 0
              ? (t.top += o - (t.top + o + e.collisionHeight - s - i))
              : (t.top =
                  !(0 < a && o <= 0) && a < o ? i + s - e.collisionHeight : i)
            : 0 < o
            ? (t.top += o)
            : 0 < a
            ? (t.top -= a)
            : (t.top = k(t.top - n, t.top));
        },
      },
      flip: {
        left: function (t, e) {
      ...
      stop: function (e, t, i) {
        ...
        (i.cancelHelperRemoval = !1),
          V.each(i.sortables, function () {
            var t = this;
            t.isOver
              ? ((i.cancelHelperRemoval = !(t.isOver = 0)),
          ...
          .on(
            ...
            function (t, i) {
              var e = s(a.$prevArrow),
                ...
                u = e.add(n);
              d.arrows
                ? (k.addClass("slick-arrow").off("click.slickExtensions"),
